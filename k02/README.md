...
78.新しい要素のデータ領域を確保する
79.80.リストにデータを挿入する
109.111.112.118.pListの中のcityIDが入力されたkeyと一致するまでループさせる
114~116.120.一致したらそれまでにループした回数を返しcityのアドレスを代入する。


## 出力結果

```
PS C:\Users\bb35319035\まっするプロ演\2020psp3\k02> ./k00
...
42208, 長崎県, 松浦市, 23309, 11164, 12145
free list. items = 21
PS C:\Users\bb35319035\まっするプロ演\2020psp3\k02>
```
